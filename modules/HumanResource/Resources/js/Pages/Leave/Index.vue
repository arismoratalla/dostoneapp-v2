            ...
            <div class="bg-gray-200 bg-opacity-25 lg:gap-8 p-2 lg:p-4">
              ...
              <div class="flex items-center justify-between ml-6 mr-6 mb-3 mt-3">
                ...
                <Modal :show="showModal" @close="closeCreateLeaveModal">
                  <Create @formSubmitted="handleFormSubmitted" :leaveTypes="leaveTypes" />
                </Modal>
              </div>

              <div class="flex-1 items-center justify-between mr-6 mb-3 mt-3">
                ...
                <table class="max-w-full table-auto ml-6 mr-6 mb-2 border-collapse">
                  ...
                  <tbody>
                    <tr v-for="leave in leaves.data" :key="leave.id"
                      class="hover:bg-gray-100 focus-within:bg-gray-100 border-t-2">
                      ...
                      <td class="border-t text-center">
                        <div class="inline-flex">
                          <svg @click="openViewRequestModal(request.id)" class="cursor-pointer" width="30px" height="30px"
                          ...
                          <svg @click="openEditRequestModal" class="cursor-pointer" width="30px" height="30px"
                            viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
              ...
              <div class="flex-1 items-center justify-between mr-6 mb-3 mt-3">
                <div class="relative overflow-x-auto">
                  <table class="max-w-full table-auto ml-6 mr-6 mb-2 border-collapse">
                    <thead class="bg-gray-300 text-black text-center font-bold">
                      <tr class="text-center font-bold">
                        <th class="pb-2 pt-2 px-20 uppercase">Leave Type</th>
                        <th class="pb-2 pt-2 px-10 uppercase">Balance</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr v-for="balance in leaveBalances" :key="balance.id"
                        class="hover:bg-gray-100 focus-within:bg-gray-100 border-t-2">
                        <td class="w-1/2 text-left text-balance">
                          {{ balance.leave_type.name }}
                        </td>
                        <td class="w-1/2 text-center text-balance">
                          {{ balance.balance }}
                        </td>
                      </tr>
                    </tbody>
